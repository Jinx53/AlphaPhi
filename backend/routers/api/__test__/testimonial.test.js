...
const route = require("../testimonial");
const request = require("supertest");

describe('Testing testimonial api', () => {
    test('GET / should return all testimonials', async () => {
    ...
    test('PUT /:_id should require auth', async () => {
        const res = await request(route).put('/123').send({author: "test"});
